...
public class GaussTests
{
	...
	{
		Init1();
		Assert.IsTrue(r == GaussMod.Invert(a, false));
	}
	[TestMethod()]
	public void ModTestVector1()
	{
		Init2();
		Assert.IsTrue(GaussMod.Do(a, b, false) == x);
	}
	[TestMethod()]
	...
	{
		Init1();
		Assert.IsTrue(r == GaussOrd.Invert(a, false));
	}
	[TestMethod()]
	public void OrdTestVector1()
	{
		Init2();
		Assert.IsTrue(GaussOrd.Do(a, b, false) == x);
	}
	[TestMethod()]
